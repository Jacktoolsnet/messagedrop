...
export class DisplayMessageRef {
  ...
  constructor(
    private readonly dialogRef: MatDialogRef<DisplayMessage, DisplayMessageCloseResult>,
...
export class DisplayMessageService {
  ...
  private activeToastRef: MatDialogRef<DisplayMessage, DisplayMessageCloseResult> | null = null;
  ...
  open(message: string, action?: string, config: DisplayMessageOpenConfig = {}): DisplayMessageRef {
    ...
    const toastRef = this.dialog.open(DisplayMessage, {
