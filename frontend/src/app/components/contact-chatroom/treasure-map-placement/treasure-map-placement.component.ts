import{ChangeDetectionStrategy,Component,inject,output,signal}from'@angular/core';import{TreasureIslandItem}from'../../../interfaces/chat-game';import{GameFeedbackService}from'../../../services/game-feedback.service';import{randomTreasureLayout,TREASURE_INVENTORY,validTreasureLayout}from'../../../utils/treasure-map-game';
