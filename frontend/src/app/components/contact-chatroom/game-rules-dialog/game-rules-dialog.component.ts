...
export interface GameRulesDialogData {
  gameType: 'trickDuel' | 'blackjack' | 'ticTacToe' | 'connectFour' | 'dotsAndBoxes' | 'rockPaperScissors' | 'code' | 'memory' | 'minefield' | 'minefieldHideSeek'|'morris'|'checkers'|'asteroidDuel'|'treasureMap'|'wordRescue'|'coinToss'|'diceRoll'|'fortuneWheel';
