...
const HELP_TOPICS = {
  ...
  tripGoRoute: {
    ...
    items: [
      ...
      {
        icon: 'map',
        titleKey: 'tripGoRoute.items.map.title',
        descriptionKey: 'tripGoRoute.items.map.desc'
      },
      {
        icon: 'flag',
      ...
      {
        icon: 'settings',
        titleKey: 'tripGoRoute.items.routeOptions.title',
        descriptionKey: 'tripGoRoute.items.routeOptions.desc'
      },
      {
        icon: 'route',
  ...
  tripGoRoutePoint: {
    titleKey: 'tripGoRoutePoint.title',
    introKey: 'tripGoRoutePoint.intro',
    items: [
      {
        icon: 'info',
        titleKey: 'tripGoRoutePoint.items.details.title',
        descriptionKey: 'tripGoRoutePoint.items.details.desc'
      },
      {
        icon: 'online_prediction',
        titleKey: 'tripGoRoutePoint.items.live.title',
      ...
      {
        icon: 'close',
        titleKey: 'tripGoRoutePoint.items.close.title',
        descriptionKey: 'tripGoRoutePoint.items.close.desc'
      },
      {
        icon: 'privacy_tip',
        titleKey: 'tripGoRoutePoint.items.privacy.title',
        descriptionKey: 'tripGoRoutePoint.items.privacy.desc'
      }
    ]
  },
  tripGoStop: {
  ...
  tileEditRelations: {
    ...
    items: [
      ...
      {
        icon: 'settings_account_box',
        titleKey: 'tileEditRelations.items.editProfile.title',
        descriptionKey: 'tileEditRelations.items.editProfile.desc'
      },
      {
        icon: 'add_location',
