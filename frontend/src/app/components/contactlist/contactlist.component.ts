...
export class ContactlistComponent {
  ...
  getPreviewIcon(preview: ContactMessagePreview): string {
    if (preview.kind === 'game') {
      ...
      return gameType==='trickDuel'
        ?'filter_7'
        :gameType==='blackjack'
        ?'playing_cards'
        :gameType==='fortuneWheel'
        ?'data_usage'
        :gameType==='diceRoll'
        ?'casino'
        :gameType==='coinToss'
        ...
        ?'map'
        :gameType==='asteroidDuel'
        ?'rocket_launch'
        :gameType==='checkers'
        ?'grid_view'
        :gameType==='morris'
        ?'hub'
        :gameType === 'minefieldHideSeek'
        ? 'radar'
        : gameType === 'minefield'
        ? 'grid_on'
        : gameType === 'memory'
  ...
  private resolvePreviewText(message: ContactMessage, payload: ShortMessage | null): string {
    ...
    if (payload.game) {
      ...
      const prefixKey = payload.game.type === 'trickDuel'
        ...
        : payload.game.type === 'asteroidDuel'
        ? 'common.contact.chatroom.games.asteroidDuelPreviewPrefix'
        : payload.game.type === 'checkers'
        ? 'common.contact.chatroom.games.checkersPreviewPrefix'
        : payload.game.type === 'morris'
        ? 'common.contact.chatroom.games.morrisPreviewPrefix'
        : payload.game.type === 'minefieldHideSeek'
        ...
        : payload.game.type === 'dotsAndBoxes'
          ...
          : payload.game.type === 'rockPaperScissors'
            ? 'common.contact.chatroom.games.rockPaperScissorsPreviewPrefix'
