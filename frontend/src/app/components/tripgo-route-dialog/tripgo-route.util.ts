...
export function tripGoSegmentIcon(segment: TripGoRouteSegment): string {
  ...
  if (identifier.includes('me_car') || identifier.includes('car')) return 'directions_car';
  if (identifier.includes('me_mic_bic') || identifier.startsWith('cy_') || identifier.includes('bicycle')) {
