...
router.get('/search/:searchTerm/:limit', async (req, res) => {
    let response = { status: 0 };
...
router.get('/noboundedsearch/:searchTerm/:limit/:viewbox', async (req, res) => {
    let response = { status: 0 };
...
router.get('/boundedsearch/:searchTerm/:limit/:viewbox', async (req, res) => {
    let response = { status: 0 };
    const { searchTerm, limit, viewbox } = req.params;
    const db = req.database.db;
