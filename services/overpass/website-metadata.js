...
function createWebsiteMetadataClient({
  timeoutMs = Number(process.env.OVERPASS_WEBSITE_METADATA_TIMEOUT_MS || DEFAULT_TIMEOUT_MS),
  maxBytes = Number(process.env.OVERPASS_WEBSITE_METADATA_MAX_BYTES || DEFAULT_MAX_BYTES),
  maxRedirects = Number(process.env.OVERPASS_WEBSITE_METADATA_MAX_REDIRECTS || 3),
  userAgent = process.env.OVERPASS_USER_AGENT || 'MessageDrop-Overpass-Service/1.0',
